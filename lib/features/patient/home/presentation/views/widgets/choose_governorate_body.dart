...
import 'package:graduation_project/features/patient/home/presentation/views/choose_city_view.dart';
...
class ChooseGovernorateBody extends StatelessWidget {
  const ChooseGovernorateBody(
      {super.key,  this.specialty, required this.type});
