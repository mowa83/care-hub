...
import 'package:graduation_project/features/patient/splash/presentation/views/splash2_view.dart';
        ...
        children: [
          ...
          Container(
            ...
            child: Align(
                ...
                child: Image.asset(
                  'assets/images/splash_doctor1.png',
                  height: 495.h,
                  width: 375.w,
                )),
          ),
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    const GreyText(text: 'Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of it over 2000 years old.'),
                    SizedBox(
                      height: 20.h,
                    ),
                    // const NavigationRow(),
                    ...
                    SizedBox(
                      ...
                      child: const Row(
                        ...
                        children: [SkipButton(), ShortNextButton(nextScreen: Splash2View(),)],
                      ),
                    ),
