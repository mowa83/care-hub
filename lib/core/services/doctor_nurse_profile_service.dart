...
class ApiService {
  ...
  Future<DoctorNurseProfileModel?> fetchProfileModel(String url) async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        return DoctorNurseProfileModel.fromJson(data);
      } else {
  ...
  Future<bool> updateProfile(DoctorNurseProfileModel updatedProfile,String url) async {
    try {
      final headers = await _getHeaders();
