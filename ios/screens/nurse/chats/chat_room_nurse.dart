...
class ChatRoomNurse extends StatefulWidget {
  const ChatRoomNurse({super.key});

  @override
  ChatRoomNurseState createState() => ChatRoomNurseState();
}

class ChatRoomNurseState extends State<ChatRoomNurse> {
